...
class TestInfoImpl {
  ...
  _addStep(data, parentStep) {
    ...
    if (!parentStep) parentStep = _utils.zones.zoneData('stepZone', (0, _utils.captureRawStack)()) || undefined;
    ...
    const step = {
      ...
      complete: result => {
        ...
        this._traceEvents.push((0, _utils.createAfterActionTraceEventForStep)(stepId, serializeAttachments(this.attachments, initialAttachments), errorForTrace));
      }
    };
    ...
    this._traceEvents.push((0, _utils.createBeforeActionTraceEventForStep)(stepId, (_parentStep = parentStep) === null || _parentStep === void 0 ? void 0 : _parentStep.stepId, data.apiName || data.title, data.params, data.wallTime, data.location ? [data.location] : []));
    return step;
  }
  _appendStdioToTrace(type, chunk) {
...
function serializeAttachments(attachments, initialAttachments) {
