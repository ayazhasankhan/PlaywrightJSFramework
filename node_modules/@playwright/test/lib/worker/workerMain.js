...
class WorkerMain extends _process.ProcessRunner {
  ...
  constructor(params) {
    ...
    process.stdout.write = chunk => {
      ...
      (_this$_currentTest = this._currentTest) === null || _this$_currentTest === void 0 ? void 0 : _this$_currentTest._appendStdioToTrace('stdout', chunk);
      return true;
    };
    if (!process.env.PW_RUNNER_DEBUG) {
      process.stderr.write = chunk => {
        ...
        (_this$_currentTest2 = this._currentTest) === null || _this$_currentTest2 === void 0 ? void 0 : _this$_currentTest2._appendStdioToTrace('stderr', chunk);
        return true;
      };
    }
  }
  ...
  unhandledError(error) {
    ...
    const isCurrentTestExpectedToFail = ((_this$_currentTest4 = this._currentTest) === null || _this$_currentTest4 === void 0 ? void 0 : _this$_currentTest4.expectedStatus) === 'failed';
  ...
  async _runTest(test, retry, nextTest) {
    ...
    await testInfo._runWithTimeout(async () => {
      ...
      await (0, _utilsBundle.rimraf)(testInfo.outputDir).catch(() => {});
    ...
    await testInfo._runAsStep({
      ...
      await testInfo._runWithTimeout(async () => {
        ...
        (0, _util2.debugTest)(`on-test-function-finish callback started`);
        ...
        (0, _util2.debugTest)(`on-test-function-finish callback finished`);
    ...
    if (!preserveOutput) await (0, _utilsBundle.rimraf)(testInfo.outputDir).catch(() => {});
  }
...
function chunkToParams(chunk, encoding) {
