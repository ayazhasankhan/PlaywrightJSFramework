...
class SnapshotHelper {
  ...
  handleDifferent(actual, expected, previous, diff, diffError, log, title = `${this.kind} comparison failed:`) {
    ...
    if (expected !== undefined) {
      ...
      output.push(`Expected: ${_utilsBundle.colors.yellow(this.snapshotPath)}`);
    }
...
function toMatchSnapshot(received, nameOrOptions = {}, optOptions = {}) {
  ...
  const helper = new SnapshotHelper(testInfo, testInfo.snapshotPath.bind(testInfo), determineFileExtension(received), ((_testInfo$_projectInt = testInfo._projectInternal.expect) === null || _testInfo$_projectInt === void 0 ? void 0 : _testInfo$_projectInt.toMatchSnapshot) || {}, nameOrOptions, optOptions);
  if (this.isNot) {
