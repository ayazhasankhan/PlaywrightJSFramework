  ...
  get(target, matcherName, receiver) {
    ...
    return (...args) => {
      ...
      const reportStepError = jestError => {
        ...
        const serializedError = (0, _util.serializeError)(jestError);
        ...
        if (this._info.isSoft) testInfo._failWithError(serializedError, false /* isHardError */);else throw jestError;
      };
      const finalizer = () => {
        step === null || step === void 0 ? void 0 : step.complete({});
      };
      ...
      if (this._info.isPoll || matcherName in customAsyncMatchers && matcherName !== 'toPass') {
        return (async () => {
          try {
            ...
            await _utils.zones.run('expectZone', expectZone, async () => {
