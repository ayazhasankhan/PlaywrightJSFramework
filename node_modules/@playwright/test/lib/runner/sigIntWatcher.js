...
FixedNodeSIGINTHandler._dispatch = () => {
  if (FixedNodeSIGINTHandler._ignoreNextSIGINTs) return;
  FixedNodeSIGINTHandler._ignoreNextSIGINTs = true;
  setTimeout(() => {
    FixedNodeSIGINTHandler._ignoreNextSIGINTs = false;
    ...
    if (!FixedNodeSIGINTHandler._handlers.length) FixedNodeSIGINTHandler._uninstall();
  }, 1000);
  for (const handler of FixedNodeSIGINTHandler._handlers) handler();
};