...
class Runner {
  ...
  async runAllTests() {
    ...
    let status = 'passed';
    if (testRun.phases.find(p => p.dispatcher.hasWorkerErrors()) || (_testRun$rootSuite = testRun.rootSuite) !== null && _testRun$rootSuite !== void 0 && _testRun$rootSuite.allTests().some(test => !test.ok())) status = 'failed';
