  ...
  async update(config) {
    ...
    this._watcher = _utilsBundle.chokidar.watch([...projectClosure.keys()].map(p => p.project.testDir), {
      ...
      this._timer = setTimeout(() => {
        ...
        (_this$_notifyDirtyFil = this._notifyDirtyFiles) === null || _this$_notifyDirtyFil === void 0 ? void 0 : _this$_notifyDirtyFil.call(this);
      }, 250);
    });
  }
...
async function runTests(config, failedTestIdCollector, options) {
  ...
  if (testRun.phases.find(p => p.dispatcher.hasWorkerErrors()) || hasFailedTests) status = 'failed';
