 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(q,_){var R=q.length;q.push(_);e:for(;0<R;){var G=R-1>>>1,ne=q[G];if(0<o(ne,_))q[G]=_,q[R]=ne,R=G;else break e}}function n(q){return q.length===0?null:q[0]}function r(q){if(q.length===0)return null;var _=q[0],R=q.pop();if(R!==_){q[0]=R;e:for(var G=0,ne=q.length,kr=ne>>>1;G<kr;){var Rt=2*(G+1)-1,Zo=q[Rt],At=Rt+1,xr=q[At];if(0>o(Zo,R))At<ne&&0>o(xr,Zo)?(q[G]=xr,q[At]=R,G=At):(q[G]=Zo,q[Rt]=R,G=Rt);else if(At<ne&&0>o(xr,R))q[G]=xr,q[At]=R,G=At;else break e}}return _}function o(q,_){var R=q.sortIndex-_.sortIndex;return R!==0?R:q.id-_.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var l=Date,c=l.now();e.unstable_now=function(){return l.now()-c}}var i=[],u=[],h=1,m=null,d=3,y=!1,v=!1,S=!1,w=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,a=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(q){for(var _=n(u);_!==null;){if(_.callback===null)r(u);else if(_.startTime<=q)r(u),_.sortIndex=_.expirationTime,t(i,_);else break;_=n(u)}}function k(q){if(S=!1,p(q),!v)if(n(i)!==null)v=!0,Nn(E);else{var _=n(u);_!==null&&qn(k,_.startTime-q)}}function E(q,_){v=!1,S&&(S=!1,f(L),L=-1),y=!0;var R=d;try{for(p(_),m=n(i);m!==null&&(!(m.expirationTime>_)||q&&!we());){var G=m.callback;if(typeof G=="function"){m.callback=null,d=m.priorityLevel;var ne=G(m.expirationTime<=_);_=e.unstable_now(),typeof ne=="function"?m.callback=ne:m===n(i)&&r(i),p(_)}else r(i);m=n(i)}if(m!==null)var kr=!0;else{var Rt=n(u);Rt!==null&&qn(k,Rt.startTime-_),kr=!1}return kr}finally{m=null,d=R,y=!1}}var C=!1,g=null,L=-1,A=5,D=-1;function we(){return!(e.unstable_now()-D<A)}function T(){if(g!==null){var q=e.unstable_now();D=q;var _=!0;try{_=g(!0,q)}finally{_?$():(C=!1,g=null)}}else C=!1}var $;if(typeof a=="function")$=function(){a(T)};else if(typeof MessageChannel<"u"){var ie=new MessageChannel,Ln=ie.port2;ie.port1.onmessage=T,$=function(){Ln.postMessage(null)}}else $=function(){w(T,0)};function Nn(q){g=q,C||(C=!0,$())}function qn(q,_){L=w(function(){q(e.unstable_now())},_)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(q){q.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,Nn(E))},e.unstable_forceFrameRate=function(q){0>q||125<q?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<q?Math.floor(1e3/q):5},e.unstable_getCurrentPriorityLevel=function(){return d},e.unstable_getFirstCallbackNode=function(){return n(i)},e.unstable_next=function(q){switch(d){case 1:case 2:case 3:var _=3;break;default:_=d}var R=d;d=_;try{return q()}finally{d=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(q,_){switch(q){case 1:case 2:case 3:case 4:case 5:break;default:q=3}var R=d;d=q;try{return _()}finally{d=R}},e.unstable_scheduleCallback=function(q,_,R){var G=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?G+R:G):R=G,q){case 1:var ne=-1;break;case 2:ne=250;break;case 5:ne=1073741823;break;case 4:ne=1e4;break;default:ne=5e3}return ne=R+ne,q={id:h++,callback:_,priorityLevel:q,startTime:R,expirationTime:ne,sortIndex:-1},R>G?(q.sortIndex=R,t(u,q),n(i)===null&&q===n(u)&&(S?(f(L),L=-1):S=!0,qn(k,R-G))):(q.sortIndex=ne,t(i,q),v||y||(v=!0,Nn(E))),q},e.unstable_shouldYield=we,e.unstable_wrapCallback=function(q){var _=d;return function(){var R=d;d=_;try{return q.apply(this,arguments)}finally{d=R}}}})(uu);iu.exports=uu;var Sd=iu.exports;/**
 * @license React
